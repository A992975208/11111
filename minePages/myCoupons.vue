  ...
  <view class="template-order">
    ...
    <tn-nav-bar fixed customBack :bottomShadow="false" backgroundColor="#FFFFFF">
      ...
      <view class="tn-flex tn-flex-col-center tn-flex-row-center ">
        <text class="tn-text-bold tn-text-xl tn-color-black">我的优惠券</text>
      </view>
    </tn-nav-bar>
    <view>
      <z-paging ref="paging" v-model="dataList" @query="queryList" :style="{top: vuex_custom_bar_height + 20 +'px'}">
        ...
        <template #empty>
          <tn-empty :imgWidth="width" text="暂无优惠券" :show="show" icon="/static/images/order_empty.png"></tn-empty>
        </template>
        <view>
          <view v-for="(item,index) in dataList" :key="index" class="order__item">
            <view class="order__item__head tn-flex tn-flex-direction-row tn-flex-col-center tn-flex-row-between">
              <view class="order__item__head__title">
                <text class="tn-text-bold">订单编号：{{ item.orderNo }}</text>
            ...
            <view
              ...
              <view class="order__item__content__image" @click="orderDetail(item.id)">
                <image
                    src="https://cdn.nlark.com/yuque/0/2022/jpeg/280373/1664005699066-assets/web-upload/f7a37b29-506a-4e79-937f-826334902bb4.jpeg"
            ...
            <view
              ...
              <view
                ...
                <view class="order__item__operation__right__button" @click="buyAgain">
                  <tn-button shadow shape="round" fontColor="tn-color-black" backgroundColor="tn-bg-fruit"
                             :fontSize="24" height="auto" padding="10rpx 18rpx">再次购买
                  </tn-button>
                </view>
              </view>
            </view>
