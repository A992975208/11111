        ...
        <view class="tn-flex-1 tn-padding-sm tn-margin-xs tn-radius">
          ...
          <view class="tn-flex-1 tn-padding-sm tn-margin-xs tn-radius">
            <view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
              ...
              <view class="tn-color-black tn-text-center">
                <text class="tn-text-ellipsis">学习计划</text>
              </view>
            </view>
          </view>
          <view class="tn-flex-1 tn-padding-sm tn-margin-xs tn-radius">
            <view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
              ...
              <view class="tn-color-black tn-text-center">
                <text class="tn-text-ellipsis">学习周期</text>
              </view>
            </view>
          </view>
          <view class="tn-flex-1 tn-padding-sm tn-margin-xs tn-radius">
          ...
          <block v-for="(item,index) in content" :key="index">
            <view class="tn-blogger-content__wrap">
              <view class="">
                ...
                <image class="tn-blogger-content__main-image tn-blogger-content__main-image--1 tn-margin-bottom"
                       :src="item.mainImage[0]" mode="aspectFill"></image>
              </view>
...
export default {
    ...
    data(){
      return {
        ...
        list: [
          '学会识别和管理情绪，提升人际沟通能力和心理韧性',
          '学会使用心理学工具，如认知行为疗法、冥想、正念练习，来改善生活质量。',
          '发现自我开启心灵成长之旅心理健康，让生活更美好,了解自己，做更好的自己！'
        ],
        content: [
          {
