    ...
    <view class="tn-flex tn-flex-row-around">
      <view class="user-info__container justify-content-item">
        <view class="user-info__avatar-two tn-flex-col-center tn-flex-row-center">
          <view class="tn-shadow-blur" style="width: 140rpx;height: 140rpx;background-size: cover;" :style="'background-image: url(' + require('@/static/awatar/xiong-3d-new1.png') + ')'">
          </view>
        </view>
        <view class="user-info__nick-name-two clamp-text-1">山山而川</view>
      ...
      <view class="user-info__container justify-content-item">
        <view class="user-info__avatar-one tn-flex-col-center tn-flex-row-center">
          <view class="tn-shadow-blur" style="width: 180rpx;height: 180rpx;background-size: cover;" :style="'background-image: url(' + require('@/static/awatar/xiong-3d.jpg') + ')'">
          </view>
        </view>
        <view class="user-info__nick-name-one clamp-text-1">好你个可口可乐</view>
      ...
      <view class="user-info__container justify-content-item">
        <view class="user-info__avatar-three tn-flex-col-center tn-flex-row-center">
          <view class="tn-shadow-blur" style="width: 120rpx;height: 120rpx;background-size: cover;" :style="'background-image: url(' + require('@/static/awatar/xiong-3d-new.jpg') + ')'">
          </view>
        </view>
        <view class="user-info__nick-name-three clamp-text-1">孜然肉夹馍</view>
        ...
        <view class="justify-content-item tn-margin-top">
          <view class="tn-flex tn-flex-row-center tn-flex-col-center">
            ...
            <view class="tn-flex tn-flex-row-center tn-flex-col-center">
              ...
              <view class="avatar-all">
                <view class="tn-shadow-blur" style="width: 80rpx;height: 80rpx;background-size: cover;"  :style="'background-image: url(' + require('@/static/logo.png') + ')'"
                >
                </view>
              </view>
              <view class="tn-padding-right tn-text-ellipsis">
                <view class="tn-padding-right tn-padding-left-sm tn-text-bold tn-text-lg">千果家庭教育</view>
