  ...
  <view class="template-advertise">
    ...
    <view class="adver-wrap tn-bg-white">
      ...
      <view class="detail-img">
        <image src='/static/adimg/ad.jpg' mode='widthFix' class=''></image>
      </view>
    </view>
...
<!--              :style="'background-image: url(' + require('@/static/images/study.png') + ')'"-->
              <view class="tn-shadow-blur" style="background-image:url('static/images/bg.jpg');width: 100rpx;height: 100rpx;background-size: cover;"
          ...
          <view class="tn-padding-right tn-color-black">
            <view class="tn-padding-right tn-padding-left-sm">
              <text class="tn-text-lg tn-text-bold">千果家庭教育</text>
            </view>
            <view class="tn-padding-right tn-padding-top-xs tn-padding-left-sm tn-text-ellipsis">
              <text class="tn-color-blue--dark tn-text-bold">西安千果教育科技有限公司</text>
            </view>
          </view>
        </view>
      </view>
...
<!--      </view>-->
    ...
    <tn-modal v-model="show1" :custom="true">
      <view class="custom-modal-content">
        ...
        <view class="tn-text-center tn-padding-top">联系方式 : 13272574651</view>
        <view class="tn-text-center tn-padding-top">周一至周日 08:00~22:00</view>
        <view class="tn-text-center tn-padding-top">运营地址 : 西安市曲江新区旺座E座3102</view>
      </view>
    </tn-modal>
    <!-- 压屏窗-->
...
<!--        <text class="tn-text-lg tn-color-white tn-padding-top-lg">—— 2024——</text>-->
<!--      </view>-->
<!--    </tn-landscape>-->
  </view>
</template>
