    ...
    <view class="tn-safe-area-inset-bottom" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-padding-top-xl tn-margin">
        <view class="tn-flex justify-content-item">
          ...
          <view class="">
            <text class="tn-text-lg tn-padding-right-xs tn-text-bold">话题图片</text>
            <text class="tn-text-xs tn-padding-right-xs tn-color-grey">首张为话题头像，长按排序</text>
          </view>
        </view>
      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-padding-top-xl tn-margin">
        <view class="tn-flex justify-content-item">
          ...
          <view class="tn-text-lg tn-padding-right-xs tn-text-bold">话题地点</view>
        </view>
        <view class="justify-content-item tn-text-df tn-color-grey">
          <text class="tn-padding-xs">陕西省西安市雁塔区丈八一路</text>
      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-padding-top-xl tn-margin">
        <view class="tn-flex justify-content-item">
          ...
          <view class="tn-text-lg tn-padding-right-xs tn-text-bold">微信话题群</view>
        </view>
        <view class="justify-content-item tn-text-df tn-color-grey">
      ...
      <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-padding-top-xl tn-margin">
        <view class="tn-flex justify-content-item">
          ...
          <view class="tn-text-lg tn-padding-right-xs tn-text-bold">话题分类</view>
        </view>
        <view class="justify-content-item tn-text-df tn-color-grey">
      ...
      <view class="tn-flex tn-footerfixed">
        <view class="tn-flex-1 justify-content-item tn-margin-sm tn-text-center">
          <tn-button backgroundColor="#00FFC6" padding="40rpx 0" width="60%" shadow fontBold @click="initiate">
