<template>
  <view class="template-blogger tn-safe-area-inset-bottom">
    ...
    <!-- 立体头像-->
    <view class='cube'  :style="'background-image: url(' + require('@/static/images/bg_image_1.jpg') + ')'">
        ...
        <view class="tn-flex tn-flex-row-between tn-flex-col-center tn-margin-bottom">
          <view class="justify-content-item">
            <view class="tn-flex tn-flex-col-center tn-flex-row-left">
              <!-- 图标logo -->
              <view class="ad-pic tn-shadow-blur"  :style="'background-image: url(' + require('@/static/logo.png') + ')'">
                <view class="ad-image">
                </view>
              </view>
              <view class="tn-padding-right" style="width: 65vw;">
                <view class="tn-padding-right tn-padding-left-sm tn-text-bold tn-text-lg">千果家庭教育有限公司</view>
                <view class="tn-padding-right tn-padding-left-sm tn-color-gray tn-text-ellipsis">呵护您的心理健康</view>
              </view>
  ...
  export default {
    ...
    data() {
      return {
        ...
        userInfo: {
          avatar: [
            'https://img2.baidu.com/it/u=1090452517,2487311686&fm=253&fmt=auto&app=120&f=JPEG?w=500&h=501',
            'https://q5.itc.cn/q_70/images03/20240406/2c8f1d2cd13e4d4392fa07ccaab1f219.jpeg',
            'https://iknow-pic.cdn.bcebos.com/a71ea8d3fd1f4134a1175ce3371f95cad1c85e0e',
            'https://iknow-pic.cdn.bcebos.com/a71ea8d3fd1f4134a1175ce3371f95cad1c85e0e',
            'https://iknow-pic.cdn.bcebos.com/a71ea8d3fd1f4134a1175ce3371f95cad1c85e0e',
          ],
          username: '孜然肉夹馍',
        ...
        tipsDataMessage: {
          latestMessageUserAvatar: '/static/awatar/xiong-3d.jpg',
          messageCount: 3,
          likeCount: 1290,
          hotReviewsCount: 896,
          fansCount: 962,
        ...
        content: [
          {
            ...
            userName: '孜然肉夹馍',
            date: '2021年12月20日',
            label: ['孜然肉夹馍','孜然肉夹馍','孜然肉夹馍'],
            desc: '孜然肉夹馍，助你开发酷炫UI一臂之力',
            content: '孜然肉夹馍',
            viewUser: {
              latestUserAvatar: [
